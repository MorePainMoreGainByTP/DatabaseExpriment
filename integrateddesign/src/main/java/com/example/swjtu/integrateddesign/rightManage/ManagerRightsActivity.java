...
public class ManagerRightsActivity extends AppCompatActivity {
    private static final String TAG = "ManagerRightsActivity";
    ...
    private void setActionBar() {
        ...
        user = (Manager) intent.getSerializableExtra("manager");
    ...
    private void intiData() {
        ...
        ManagerRightsViewPagerAdapter viewPagerAdapter = new ManagerRightsViewPagerAdapter(getSupportFragmentManager(), rightsFragments, tabTitles);
