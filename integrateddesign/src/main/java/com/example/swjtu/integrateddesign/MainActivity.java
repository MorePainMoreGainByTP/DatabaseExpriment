...
public class MainActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IntentFilter intentFilter = new IntentFilter("com.example.swjtu.integrateddesign.LOGIN_SUCCESS");
        registerReceiver(loginBroadcast, intentFilter);  //注册广播
    }
    ...
    //信息系统登录技术
    public void loginTechnology(View view) {
        if (!hasLogin) {
            startActivity(new Intent(this, LoginTechnologyActivity.class));
        } else {
            if (isRoot) {
